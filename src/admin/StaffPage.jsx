...
export default function StaffPage() {
  ...
  const ROLE_LABELS = {
    khidmat_guzar: 'Al-Mawaid Team Member',
    admin: 'Admin',
  ...
  const rows = staff.map(s => [
    ...
    <Badge color={ROLE_COLORS[s.role] || T.accent}>{ROLE_LABELS[s.role] || (s.role || '').replace('_', ' ')}</Badge>,
    s.phone || '—',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div>
                ...
                <select value={form.role} onChange={e => setForm(f => ({ ...f, role: e.target.value }))}
                  ...
                  <option value="khidmat_guzar">Al-Mawaid Team Member</option>
